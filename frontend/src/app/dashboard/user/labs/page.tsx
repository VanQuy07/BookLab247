      ...
      try {
        ...
        const formattedDevices: DeviceItem[] = data.map((item) => {
          ...
          return {
            ...
            price: item.price || 50000, // Giá thuê mặc định nếu backend không có
            status: deviceStatus,
                    ...
                    <div className="p-5 flex flex-col flex-1">
                      ...
                      <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                          <button disabled={device.status !== 'available' || device.quantity <= 0} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 text-white text-sm font-bold rounded-lg shadow-md transition-all active:scale-95">Mượn ngay</button>
                        </div>
                      </div>
                    </div>
                  </div>
